...
public class BookListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Display content in the toolbar
        ...
        bookAdapter.setOnItemClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                i.putExtra("coverUrl", book.getCoverUrl());
                startActivity(i);
            }
        });
    }

    public void launchBookDetailView() {
